...
def brute_force_decryption(filename="RowleyB.dat", keyfile="keywords.dat"):
    ...
    Specifications
    1. The caesar cipher has keys from 1 to n, where n is the number of available characters in the alphabet. Here it,
       that value is 127.
    ...
    try:
        ...
        print(f"Warning: The file '{filename}' does not exist. Using built-in keywords.")
